...
const PageProduct = (props) => {
	...
	const goToSellerPage = (sellerId) => {
        props.history.push(`/seller/${sellerId}`);
    };
					...
					<div className={classname(styles.topContainer)}>
						...
						<div style={{ marginLeft: 28 }}>
							...
							<div style={{ display: 'flex', alignItems: 'center' }}>
								<p style={{ fontWeight: 500, fontSize: 16, marginTop: 10, marginRight: 10 }}>
								...
								<p
									...
									onClick={() => goToSellerPage(stateProductDetail.seller_id)}
								>
									Go to Shop: {stateProductDetail.seller_name}
								</p>
							</div>
