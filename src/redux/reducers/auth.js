...
const authReducer = (state = initialState, { type, payload }) => {
  switch (type) {
    ...
    case actions.AUTH_LOGOUT_USER:
      ...
      case String(getProfileStoreCreator.pending):
        return {
          ...state,
          isGetStoreProfilePending: true,
        };
      case String(getProfileStoreCreator.fulfilled): {
        let status;
        let err;
        let data;
        ...
        return {
          ...state,
          sellerInfo: data,
          statusGetStoreProfile: status,
          errorGetStoreProfile: err,
          isGetStoreProfilePending: false,
          isGetStoreProfileFulfilled: true,
          isGetStoreProfileRejected: false,
        };
      }
      case String(getProfileStoreCreator.rejected):
        return {
          ...state,
          statusGetStoreProfile: 500,
          errorGetStoreProfile: payload,
          isGetStoreProfileRejected: true,
          isGetStoreProfilePending: false,
          isGetStoreProfileFulfilled: false,
        };
